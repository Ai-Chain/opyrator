...
<p align="center">
    ...
    <a href="https://github.com/ai-chain/opyrator/blob/main/LICENSE" title="Project License"><img src="https://img.shields.io/badge/License-MIT-green.svg"></a>
    <a href="https://github.com/ai-chain/opyrator/actions?query=workflow%3Abuild-pipeline" title="Build status"><img src="https://img.shields.io/github/workflow/status/ai-chain/opyrator/build-pipeline?style=flat"></a>
...
<p align="center">
  ...
  <a href="https://github.com/ai-chain/opyrator/issues/new?labels=bug&template=01_bug-report.md">Report a Bug</a> •
  <a href="#contribution">Contribution</a> •
  <a href="https://github.com/ai-chain/opyrator/releases">Changelog</a>
</p>
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/opyrator-header.png"/>
...
3. Run the UI server from command-line:
    ...
    <img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/opyrator-hello-world-ui.png"/>
...
4. Run the HTTP API server from command-line:
    ...
    <img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/opyrator-hello-world-api.png"/>
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/text-generation-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/generate_text/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/generate_text_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/generate-text-openapi-spec.json)
...
```bash
git clone https://github.com/ai-chain/opyrator
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/question-answering-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/question_answering/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/question_answering_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/question-answering-openapi-spec.json)
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/image-super-resolution-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/image_super_resolution/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/image_super_resolution_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/image-super-resolution-openapi-spec.json)
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/text-preprocessing-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/preprocess_text/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/preprocess_text_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/preprocess-text-openapi-spec.json)
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/language-detection-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/detect_language/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/detect_language_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/detect-language-openapi-spec.json)
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/audio-separation-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/separate_audio/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/seperate_audio_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/separate-audio-openapi-spec.json)
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/train-word-vectors-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/train_word_vectors/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/train_word_vectors_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/train-word-vectors-openapi-spec.json)
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/named-entity-recognition-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/named_entity_recognition/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/named_entity_recognition_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/named-entity-recognition-openapi-spec.json)
...
<img style="width: 100%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/components-showcase-demo.png"/>

- 📄&nbsp; [Source Code](https://github.com/ai-chain/opyrator/blob/main/examples/showcase_components/app.py)
- 🌅&nbsp; [UI Demo](https://play.mltooling.com/opyrator/demos/showcase_components_ui/)
- 🔌&nbsp; [OpenAPI Spec](https://editor.swagger.io/?url=https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/openapi-demo-specs/showcase-components-openapi-spec.json)
...
| Type                     | Channel                                              |
| ------------------------ | ------------------------------------------------------ |
| 🚨&nbsp; **Bug Reports**       | <a href="https://github.com/ai-chain/opyrator/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3Abug+sort%3Areactions-%2B1-desc+" title="Open Bug Report"><img src="https://img.shields.io/github/issues/ai-chain/opyrator/bug.svg?label=bug"></a>                                 |
| 🎁&nbsp; **Feature Requests**  | <a href="https://github.com/ai-chain/opyrator/issues?q=is%3Aopen+is%3Aissue+label%3Afeature+sort%3Areactions-%2B1-desc" title="Open Feature Request"><img src="https://img.shields.io/github/issues/ai-chain/opyrator/feature.svg?label=feature%20request"></a>                                 |
| 👩‍💻&nbsp; **Usage Questions**   |  <a href="https://github.com/ai-chain/opyrator/issues?q=is%3Aopen+is%3Aissue+label%3Asupport+sort%3Areactions-%2B1-desc" title="Open Support Request"> <img src="https://img.shields.io/github/issues/ai-chain/opyrator/support.svg?label=support%20request"></a> <a href="https://gitter.im/ai-chain/community" title="Chat on Gitter"><img src="https://badges.gitter.im/ai-chain/community.svg"></a> |
| 📢&nbsp; **Announcements** | <a href="https://gitter.im/ai-chain/community" title="Chat on Gitter"><img src="https://badges.gitter.im/mai-chain/community.svg"></a>  <a href="https://mltooling.substack.com/subscribe" title="Subscribe for updates"><img src="http://bit.ly/2Md9rxM"></a> <a href="https://twitter.com/mltooling" title="ML Tooling on Twitter"><img src="https://img.shields.io/twitter/follow/mltooling.svg?style=social&label=Follow"> |
| ❓&nbsp; **Other Requests** | <a href="mailto:team@ai-chain.org" title="Email AI Chain"><img src="https://img.shields.io/badge/email-ML Tooling-green?logo=mail.ru&logoColor=white"></a> |
...
<img style="width: 80%" src="https://raw.githubusercontent.com/ai-chain/opyrator/main/docs/images/opyrator-cli.png"/>
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/ai-chain/opyrator/issues/3)_
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/ai-chain/opyrator/issues/4)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/ai-chain/opyrator/issues/5)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/ai-chain/opyrator/issues/8)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/ai-chain/opyrator/issues/9)._
...
_WIP: This feature is not finalized yet. You can track the progress and vote for the feature [here](https://github.com/ai-chain/opyrator/issues/6)._
...
- Pull requests are encouraged and always welcome. Read our [contribution guidelines](https://github.com/ai-chain/opyrator/tree/main/CONTRIBUTING.md) and check out [help-wanted](https://github.com/ai-chain/opyrator/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3A"help+wanted"+sort%3Areactions-%2B1-desc+) issues.
- Submit Github issues for any [feature request and enhancement](https://github.com/ai-chain/opyrator/issues/new?assignees=&labels=feature&template=02_feature-request.md&title=), [bugs](https://github.com/ai-chain/opyrator/issues/new?assignees=&labels=bug&template=01_bug-report.md&title=), or [documentation](https://github.com/ai-chain/opyrator/issues/new?assignees=&labels=documentation&template=03_documentation.md&title=) problems.
- By participating in this project, you agree to abide by its [Code of Conduct](https://github.com/ai-chain/opyrator/blob/main/.github/CODE_OF_CONDUCT.md).
- The [development section](#development) below contains information on how to build and test the project after you have implemented some changes.

## Development

Refer to our [contribution guides](https://github.com/ai-chain/opyrator/blob/main/CONTRIBUTING.md#development-instructions) for information on our build scripts and development process.
