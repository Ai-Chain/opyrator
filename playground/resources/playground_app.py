...
BADGES = """
<a href="https://gitHub.com/ai-chain/opyrator" title="Star Repo"><img src="https://img.shields.io/github/stars/ai-chain/opyrator.svg?logo=github&style=social"></a>
...
if open_docker_export_feature:
    open_link("https://github.com/ai-chain/opyrator/issues/4")
    open_docker_export_feature = False

if open_zip_export_feature:
    open_link("https://github.com/ai-chain/opyrator/issues/3")
