...
def export(
    ...
    if format == ExportFormat.ZIP:
        typer.secho(
            "[WIP] This feature is not finalized yet. You can track the progress and vote for the feature here: https://github.com/ai-chain/opyrator/issues/3",
            fg=typer.colors.BRIGHT_YELLOW,
        )
    elif format == ExportFormat.DOCKER:
        typer.secho(
            "[WIP] This feature is not finalized yet. You can track the progress and vote for the feature here: https://github.com/ai-chain/opyrator/issues/4",
            fg=typer.colors.BRIGHT_YELLOW,
        )
    elif format == ExportFormat.PEX:
        typer.secho(
            "[WIP] This feature is not finalized yet. You can track the progress and vote for the feature here: https://github.com/ai-chain/opyrator/issues/5",
            fg=typer.colors.BRIGHT_YELLOW,
        )
...
def deploy(opyrator: str) -> None:
    ...
    """
    typer.secho(
        "[WIP] This feature is not finalized yet. You can track the progress and vote for the feature here: https://github.com/ai-chain/opyrator/issues/6",
        fg=typer.colors.BRIGHT_YELLOW,
    )
